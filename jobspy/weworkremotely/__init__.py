...
class WeWorkRemotely(Scraper):
    """Placeholder WeWorkRemotely scraper. Returns empty results until implemented."""
    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        log.info("WeWorkRemotely: placeholder scraper called — returning empty JobResponse")
